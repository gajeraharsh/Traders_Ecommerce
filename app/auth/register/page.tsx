...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Welcome to ShopVerse. Please check your email to verify your account.",
    });
  ...
  const handleSocialLogin = (provider: string) => {
    toast({
      ...
      description: `Redirecting to ${provider} registration...`,
    });
  };
            ...
            <div className="max-w-md mx-auto">
              <Card>
                <CardHeader className="text-center">
                  ...
                  <p className="text-muted-foreground">Join ShopVerse today</p>
                </CardHeader>
